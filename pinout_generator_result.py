...
class PinoutDialog ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		output_formatChoices = [ u"List", u"CSV", u"HTML table", u"Markdown table", u"C/C++ code (#define)", u"C/C++ code (const int)", u"C/C++ code (enum)", u"Python (dict)", u"Rust (enum)", u"WireViz ", u"FPGA (XDC format)", u"FPGA (PDC format)" ]
